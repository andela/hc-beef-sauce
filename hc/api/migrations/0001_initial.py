# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-07-13 15:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('up', 'Up'), ('down', 'Down'), ('new', 'New'), ('paused', 'Paused'), ('nag', 'Nag')], default='new', max_length=6)),
                ('nag_after', models.DateTimeField(blank=True, null=True)),
